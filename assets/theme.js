(function (factory) {
  ...
  function calculateDeliveryFrequency(foodWilllastWithQuantity) {
  ...
  var ProductVariants = /*#__PURE__*/function () {
    ...
    _createClass(ProductVariants, [{
      ...
      value: function _onVariantChanged(previousVariant, newVariant) {
		...
		this._updateFoodWillLast(newVariant); // 9th: food Will Last calculate
        
        this._getNutrionalValue(newVariant) ; // 10th: get Nutrioanal Value
      ...
      value: function _updateProductPrices(newVariant, previousVariant) {
        ...
        console.log('I am seeing' , newVariant )
        ...
        if (!newVariant) {
          ...
          if (newVariant['compare_at_price'] > newVariant['price']) {
            ...
            productPrices.innerHTML= "<div class=\"rowDelivery\"><div class=\"priceArea\"><span class=\"price\"><span class=\"visually-hidden\">".concat(window.languages.productSalePrice, "</span>").concat(Currency.formatMoney(newVariant['price'], window.theme.moneyFormat), "</span> </div> <div id=\"deliveryNutrionalId\" class=\"deliveryFrequencyArea\"><div class=\"nutrionalColumn\" style=\"cursor: pointer;\" onclick=\"onclickNutrion(customer_email)\"><div class=\"flexWidth\"><div class=\"progressBarSuccess\"><div class=\"progress progressNutrionalScore\"><div id=\"nutrionalProgressBar\" class=\"progress-bar bg-danger\" role=\"progressbar\" aria-valuenow=0 aria-valuemin=\"0\" aria-valuemax=\"100\"/> </div> </div> <div class=\"flexRow\"> <h2 class=\"foodItemNutrition\"> 85% </h2> <p class=\"Nutritional-RankingFood\"> Nutritional Score </p> </div> </div> </div> </div> </div> <div class=\"bestValue desktopValue\" id=\"bestValues\" style=\"cursor: pointer;\" onclick=\"onclickNutrion(customer_email)\">  </div> ");
          }
      ...
      key: "_updateFoodWillLast",
      value: function updateFoodWillLast(newVariant) {
            ...
            var xhttp = new XMLHttpRequest();
              xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                  ...
                  $('#quantity-qb').val();
                  let foodWillLast = Math.floor(newVariant.weight /1000*this.responseText);
      ...
      key: "_getNutrionalValue",
      value: function getNutrionalValue(newVariant) {
